CREATE OR REPLACE TABLE `dh-darkstores-stg.dev_dmart._qcls_product_stream_subset_pelican_mar22ndtomay2nd`
AS 
...
SELECT
  ...
  WHERE TRUE
    ...
    and date(timestamp) between '2023-03-22' and  '2023-05-02'

CREATE OR REPLACE TABLE `dh-darkstores-stg.local_shops_analytics.pelican_oos_availability_all_sourceaccuracy_basetemp_sku_mar22tomay2`
-- partition by timestamp_valid_from
AS
...
from `dh-darkstores-stg.dev_dmart._qcls_product_stream_subset_availability_updates_mar22ndtomay2nd` as a 
...
SELECT 
  ...
  , a.active_previous
  , a.source_previous
  , a.source_previous_availability
...
LEFT JOIN `dh-darkstores-stg.dev_dmart._qcls_pelican_orders_productlevel_2023_mar22tomay2` AS b
ON a.global_entity_id = b.global_entity_id
